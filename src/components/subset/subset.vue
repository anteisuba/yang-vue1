<template>
  <div class="subset">
    ...
    <yk-space wrap>
      <div
        class="subset__menu"
        :class="{ 'subset__menu-seledred': selected == '-1all' }"
      ...
      <div
        ...
        :key="item.id"
        :class="{ 'subset__menu-seledred': selected == item.id + 'state' }"
      ...
      <div
        ...
        :key="item.id"
        :class="{ 'subset__menu-seledred': selected == item.id + 'subset' }"
    ...
    <yk-space style="flex: none">
      <yk-popconfirm
        ...
        tigger="click"
      >
        <yk-text type="primary"> <IconCirclePlusOutline style="margin-right: 4px" />新建 </yk-text>
        <template #content>
